...
#ifndef POSE_ESTIMATION_HIGHDELAYPOSEESTIMATOR_TASK_HPP
...
namespace pose_estimation {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','pose_estimation::HighDelayPoseEstimator')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class HighDelayPoseEstimator : public HighDelayPoseEstimatorBase
    {
    ...
    public:
         ...
         * 
         */
        HighDelayPoseEstimator(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of HighDelayPoseEstimator
         */
