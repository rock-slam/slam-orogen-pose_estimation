...
#ifndef POSE_ESTIMATION_ORIENTATIONESTIMATOR_TASK_HPP
#define POSE_ESTIMATION_ORIENTATIONESTIMATOR_TASK_HPP
...
namespace pose_estimation {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','pose_estimation::OrientationEstimator')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class OrientationEstimator : public OrientationEstimatorBase
    {
    ...
    public:
         ...
         * 
         */
        OrientationEstimator(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of OrientationEstimator
         */
